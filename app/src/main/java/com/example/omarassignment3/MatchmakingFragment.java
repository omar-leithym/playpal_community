...
public class MatchmakingFragment extends Fragment {
    ...
    public static MatchmakingFragment newInstance(String sport) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        new FetchPlayersTask(getContext(), null, null, null, selectedSport).execute(); // Load all players initially
    ...
    private void showFilterDialog() {
        ...
        Spinner levelSpinner = filterView.findViewById(R.id.levelSpinner);
        ...
        applyButton.setOnClickListener(v -> {
            ...
            new FetchPlayersTask(getContext(), location, gender, level, selectedSport).execute();
    ...
    private class FetchPlayersTask extends AsyncTask<Void, Void, List<Player>> {
        ...
        FetchPlayersTask(Context context, String location, String gender, String level, String sport) {
        ...
        protected List<Player> doInBackground(Void... voids) {
            ...
            try {
                ...
                // Construct the URL
                String baseUrl = "http://10.0.2.2:3001/matchmake";
                String query = String.format("?location=%s&gender=%s&level=%s&sport=%s", location, gender, level, sport);
